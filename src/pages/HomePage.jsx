            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3">
                <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-slate-600">
                    <span className="flex items-center gap-1.5">
                        ...
                        <strong className="text-slate-800">9.4/10</strong> {t('home.trustRating')}
                    </span>
        ...
        <div className="pb-16 md:pb-0">
            ...
            <section className="py-14 px-4 sm:px-6 max-w-6xl mx-auto">
                <div className="text-center mb-10">
                    <h2 className="text-2xl sm:text-3xl font-black text-slate-900 mb-2">{t('home.chooseTitle')}</h2>
                    <p className="text-slate-500 max-w-lg mx-auto">{t('home.chooseSubtitle')}</p>
                </div>
            ...
            {(loading || featured.length > 0) && (
                <section className="pb-14 px-4 sm:px-6 max-w-6xl mx-auto">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h2 className="text-2xl sm:text-3xl font-black text-slate-900">{t('home.featuredTitle')}</h2>
                            <p className="text-slate-500 text-sm mt-1">{t('home.featuredSubtitle')}</p>
                        </div>
                    </div>
            ...
            <section className="py-14 bg-gradient-to-br from-slate-900 to-slate-800">
                <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-black text-white mb-3">{t('home.whatsappTitle')}</h2>
