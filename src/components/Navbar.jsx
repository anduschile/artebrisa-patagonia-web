...
function LanguageSwitcher({ lang, pathname, variant = 'desktop', onNavigate }) {
    ...
    if (variant === 'mobile') {
        return (
            <div className="px-4">
                <p className="text-xs text-slate-400 font-semibold uppercase mb-2">Idioma</p>
                ...
                {menuOpen && (
                    ...
                    >
                        <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col gap-1">
                            {[
                                { to: homeHref, label: 'Inicio', end: true },
                                { to: cabanasHref, label: 'Cabañas', end: false },
                                { to: deptosHref, label: 'Departamentos', end: false },
                            ].map(link => (
