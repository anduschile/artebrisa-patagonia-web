        ...
        <section id="tarifas" className="py-16 bg-slate-50">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
                    <h2 className="text-2xl sm:text-3xl font-black text-slate-900 mb-3">{t('rates.title')}</h2>
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="bg-primary-600 text-white text-xs font-semibold uppercase tracking-wide">
                                    <th className="text-left px-5 py-4">{t('rates.tableUnit')}</th>
                                    <th className="text-center px-4 py-4">{t('rates.tableCapacity')}</th>
                                    <th className="text-right px-5 py-4 whitespace-nowrap">{t('rates.tableRate')}</th>
                                </tr>
                            </thead>
                            <tbody>
                                {loading ? (
                                    <tr><td colSpan="3" className="py-10 text-center text-slate-400">{t('rates.loading')}</td></tr>
                                ) : units.map((u, i) => (
                ...
                >
                    <h3 className="text-base font-bold text-slate-800 mb-4">{t('rates.includedTitle')}</h3>
